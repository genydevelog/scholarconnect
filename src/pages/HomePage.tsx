            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/search">
                <Button 
                  ...
                  variant="primary" 
                  icon={Search}
                  className="bg-white text-blue-600 hover:bg-gray-100 shadow-lg border-2 border-white font-semibold w-full sm:w-auto px-8"
                >
              ...
              <Link to="/institutions">
                <Button 
                  ...
                  variant="outline" 
                  icon={ArrowRight}
                  className="border-2 border-white text-white hover:bg-white hover:text-blue-600 shadow-lg font-semibold w-full sm:w-auto px-8 transition-all duration-200"
                >
